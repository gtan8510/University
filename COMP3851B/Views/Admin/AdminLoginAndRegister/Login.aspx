<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="COMP3851B.Views.Admin.AdminLoginAndRegister.Login" %>
            ...
            <div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
                <div class="pr-lg-5">
                    ...
                    <div class="col-lg-5 px-lg-4">
                        <h1 class="text-base text-primary text-uppercase mb-4">Log in</h1>
                       ...
                       <br />
                        ...
                        <br /><br />
                        <asp:Button ID="btnAdminHome" runat="server" Text="Admin Home" CssClass="btn btn-warning" Height="50px" Width="400px" />
                    </div>

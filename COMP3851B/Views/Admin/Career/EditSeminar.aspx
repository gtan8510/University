...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-left: 212px">
        <div style="font-size:x-large" align="center">Edit Seminar</div>
        <table class="dataTable">
            ...
            <tr>
                ...
                <td style="width: 172px">&nbsp;</td>
                <td>
                    <asp:GridView ID="GridView1" runat="server" Width="1200px" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" CssClass="offset-sm-0" DataKeyNames="seminarID" ForeColor="Black" HorizontalAlign="Center">
                        <Columns>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="COMP3851B.Views.User.Sports.About" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>


<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="heading" style="background:url(html/images/ESPORTS3.JPG) no-repeat">
   <h1>about us</h1>
</div>
...
<section class="about">
   ...
   <div class="image">
      <img src="html/images/MAGNUS.JPG" alt="">
   </div>
   ...
   <div class="content">
      ...
      <div class="icons-container">
         ...
         <div class="icons">
            ...
            <span>Not Costly</span>
         </div>
         <div class="icons">
            <i class="fas fa-headset"></i>
            <span>Play Like you mean it</span>
         </div>
      </div>
   </div>
...
<section class="reviews">
   ...
   <h1 class="heading-title"> members reviews </h1>
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <img src="html/images/pic-1.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <img src="html/images/pic-2.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>Ezra Bryan</h3>
            <span>E-sports Club</span>
            <img src="html/images/pic-3.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <img src="html/images/pic-4.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <img src="html/images/pic-5.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minus facilis laudantium magnam saepe magni ullam possimus laborum voluptas, veniam ipsum officiis quae doloribus minima ut quis. Molestiae qui distinctio possimus?</p>
            <h3>Bego</h3>
            <span>Valorant rant</span>
            <img src="html/images/pic-6.png" alt="">
         </div>
